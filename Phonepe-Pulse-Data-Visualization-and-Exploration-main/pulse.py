...
icon = Image.open(r"C:\Users\balasankaran.s\Desktop\Project 2\PhonePe_Logo.png")
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By Bala",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Bala*!
...
with st.sidebar:
    selected = option_menu("Menu", ["Home", "Top Charts", "Explore Data", "About"],
                           ...
                           styles={"nav-link": {"font-size": "20px", "text-align": "left", "margin": "-2px",
                                                "--hover-color": "#b27eff"},
                                   "nav-link-selected": {"background-color": "#fcbf49"}})
# MENU 1 - HOME
if selected == "Home":
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\balasankaran.s\Desktop\pulse\Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    st.write("##### https://github.com/Bala-S16")
